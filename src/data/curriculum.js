...
export const product = {
  name: 'SkillForge AI: Bootcamp nghề AI',
  ...
  learningLoop: ['Học', 'Lab', 'Code', 'Build', 'Giải thích', 'Portfolio'],
...
export const scoreWeights = [
  { id: 'concepts', label: 'Khái niệm AI', weight: 12, description: 'Hiểu AI, ML, DL, LLM, token, RAG, hallucination, đánh giá.' },
  { id: 'pythonData', label: 'Python & Dữ liệu', weight: 22, description: 'Có code mission Python, CSV, JSON, làm sạch dữ liệu, insight.' },
  { id: 'mlBasics', label: 'Nền tảng ML', weight: 18, description: 'Có project train/test, regression/phân loại, metric, limitation.' },
  { id: 'llmApps', label: 'LLM/RAG/App', weight: 24, description: 'Có Document Q&A/RAG offline, trích nguồn, no-answer, đánh giá.' },
  { id: 'portfolio', label: 'Portfolio & Phỏng vấn', weight: 24, description: 'Có evidence: GitHub, README, screenshot, CV line, interview defense.' }
]

export const weeklyPlan = [
  { week: 1, title: 'Bản đồ nghề + nền tảng AI', outcome: 'Biết AI Engineer là gì và giải thích được AI/ML/LLM/RAG bằng tiếng người.', deliverable: 'Cam kết học + ghi chú khái niệm AI.' },
  { week: 2, title: 'Python cốt lõi cho AI', outcome: 'Biết biến, hàm, list/dict, file, JSON và debug cơ bản.', deliverable: 'CLI từ điển AI.' },
  { week: 3, title: 'Tư duy dữ liệu', outcome: 'Biết đọc dữ liệu, làm sạch dữ liệu và rút insight đơn giản.', deliverable: 'Bộ phân tích insight CSV.' },
  { week: 4, title: 'Nền tảng Machine Learning', outcome: 'Hiểu train/test, prediction, metric, overfitting và limitation.', deliverable: 'ML Predictor Demo.' },
  { week: 5, title: 'Ứng dụng LLM', outcome: 'Hiểu prompt, context, hallucination, đánh giá và RAG workflow.', deliverable: 'Mini-lab Prompt/RAG.' },
  { week: 6, title: 'Hỏi đáp tài liệu offline', outcome: 'Xây logic truy xuất bằng keyword, trả lời có nguồn, no-answer.', deliverable: 'Document Q&A Assistant bản offline.' },
  { week: 7, title: 'Workflow tự động hóa AI', outcome: 'Biến input thô thành checklist, phân loại, báo cáo và phản hồi.', deliverable: 'Workflow tự động hóa AI.' },
  { week: 8, title: 'Portfolio + bảo vệ project khi phỏng vấn', outcome: 'Hoàn thiện GitHub, README, CV line, demo và câu trả lời phỏng vấn.', deliverable: 'Báo cáo Capstone + bộ hồ sơ ứng tuyển.' },
  { week: 9, title: 'Lộ trình nâng cấp', outcome: 'Biết cách nâng offline RAG lên API/vector DB/backend khi sẵn sàng.', deliverable: 'Ghi chú kiến trúc bước tiếp theo.' },
  { week: 10, title: 'Phỏng vấn thử', outcome: 'Trả lời được câu hỏi về project, trade-off, lỗi và hướng cải thiện.', deliverable: 'Kịch bản bảo vệ project khi phỏng vấn.' },
  { week: 11, title: 'Dọn code + đánh bóng portfolio', outcome: 'Dọn README, ảnh demo, limitation, test cases, code structure.', deliverable: 'Repo sẵn sàng đưa vào portfolio.' },
  { week: 12, title: 'Sprint ứng tuyển', outcome: 'Biết chọn vị trí phù hợp và nộp hồ sơ có chiến lược.', deliverable: 'Checklist nộp hồ sơ.' }
]

export const moduleBlueprints = [
  {
    id: 'm0-career', number: 0, title: 'Nhập môn nghề AI Engineer', short: 'Bản đồ nghề', group: 'concepts', outcome: 'Chọn đúng hướng ứng tuyển và hiểu job không ảo tưởng.', color: 'emerald',
  ...
  {
    id: 'm1-foundation', number: 1, title: 'Tư duy AI cho người mới', short: 'Nền tảng AI', group: 'concepts', outcome: 'Giải thích được các khái niệm lõi bằng tiếng người và bằng ngôn ngữ phỏng vấn.', color: 'cyan',
  ...
  {
    id: 'm2-python', number: 2, title: 'Python for AI', short: 'Python lõi', group: 'pythonData', outcome: 'Viết được script nhỏ để xử lý dữ liệu, JSON/CSV và mô phỏng AI workflow.', color: 'amber',
  ...
  {
    id: 'm3-data', number: 3, title: 'Data for AI', short: 'Tư duy dữ liệu', group: 'pythonData', outcome: 'Hiểu dữ liệu trước khi dùng model, biết làm sạch và đánh giá dữ liệu.', color: 'lime',
  ...
  {
    id: 'm4-ml', number: 4, title: 'Nền tảng Machine Learning', short: 'Nền tảng ML', group: 'mlBasics', outcome: 'Hiểu cách model học, dự đoán, đánh giá và sai lỗi.', color: 'violet',
  ...
  {
    id: 'm5-llm', number: 5, title: 'Ứng dụng LLM Engineering', short: 'App LLM', group: 'llmApps', outcome: 'Hiểu cách xây app AI hiện đại bằng prompt, context, truy xuất và đánh giá.', color: 'sky',
    topics: ['LLM app architecture', 'Prompt instruction rõ ràng', 'System vs user prompt', 'Few-shot examples', 'Context stuffing là gì?', 'Chunking tài liệu', 'Keyword truy xuất', 'Vector truy xuất concept', 'Source citation', 'No-answer behavior', 'Guardrails cơ bản', 'Evaluation set', 'Faithfulness check', 'Latency/cost thinking', 'Upgrade path từ offline lên API']
  },
  {
    id: 'm6-automation', number: 6, title: 'AI Automation Engineering', short: 'Tự động hóa', group: 'llmApps', outcome: 'Dùng AI để xử lý quy trình thật: phân loại, trích xuất, checklist, báo cáo.', color: 'rose',
    topics: ['Workflow thinking', 'Quy ước input/output', 'Classification task', 'Extraction task', 'Summarization task', 'Checklist generation', 'Report generation', 'Human approval step', 'Error handling trong workflow', 'Audit log', 'Automation limitation', 'Demo workflow cho khách hàng']
  },
  {
    id: 'm7-safety-production', number: 7, title: 'AI Safety & Production Thinking', short: 'An toàn + Production', group: 'llmApps', outcome: 'Biết xây AI app có kiểm soát: privacy, prompt injection, đánh giá, logging, fallback và human review.', color: 'orange',
  ...
  {
    id: 'm8-portfolio', number: 8, title: 'Deployment & Portfolio', short: 'Sẵn sàng ứng tuyển', group: 'portfolio', outcome: 'Biến project thành bằng chứng ứng tuyển: GitHub, README, demo, CV, phỏng vấn.', color: 'slate',
...
export const lessons = moduleBlueprints.flatMap((module) => module.topics.map((topic, index) => {
  ...
  return {
    ...
    level: index < 4 ? 'Nhập môn' : index < 9 ? 'Thực hành' : 'Sẵn sàng nghề',
...
export const terms = [
  ...
  ['Context Window', 'Lượng nội dung model có thể nhìn trong một lần trả lời.', 'Như bàn làm việc chỉ để được vài tờ giấy.', 'Context window giới hạn tổng token prompt + output.', 'Tài liệu dài cần chunk/truy xuất.'],
  ['Embedding', 'Biến chữ thành vector số để so sánh ý nghĩa.', 'Câu gần nghĩa nằm gần nhau trên bản đồ.', 'Embedding biểu diễn ngữ nghĩa trong không gian vector.', 'Embedding không tự trả lời; nó hỗ trợ truy xuất.'],
  ['RAG', 'AI tìm tài liệu liên quan trước rồi mới trả lời.', 'Luật sư mở hồ sơ trước khi tư vấn.', 'Retrieval-Augmented Generation kết hợp truy xuất + generation.', 'RAG giảm hallucination nhưng không đảm bảo đúng 100%.'],
  ['Chunking', 'Chia tài liệu dài thành đoạn nhỏ.', 'Cắt sách thành trang để dễ tìm.', 'Chunking giúp truy xuất chọn đoạn liên quan trong giới hạn context.', 'Chunk quá dài hoặc quá ngắn đều có vấn đề.'],
  ...
  ['Hallucination', 'AI trả lời nghe hợp lý nhưng sai hoặc không có nguồn.', 'Một người đoán bừa nhưng nói rất tự tin.', 'Hallucination xảy ra do thiếu context, prompt kém, model bias hoặc truy xuất sai.', 'Cần no-answer, citation, đánh giá.'],
...
export const labs = [
  { id: 'lab-token', type: 'Lab trực quan', title: 'Token & Context Demo', goal: 'Thấy vì sao tài liệu dài cần chia nhỏ.', scenario: 'Một tài liệu quá dài không thể đưa hết vào prompt.', steps: ['Tách câu thành token giả lập', 'Tính số token ước lượng', 'Chọn đoạn liên quan thay vì nhét toàn bộ'], reflection: 'Context là tài nguyên giới hạn; RAG giúp chọn đúng phần cần đọc.' },
  { id: 'lab-truy xuất', type: 'Lab RAG', title: 'Keyword Retrieval Offline', goal: 'Hiểu truy xuất trước khi học vector database.', scenario: 'Người dùng hỏi về hallucination, hệ thống phải tìm đoạn tài liệu liên quan.', steps: ['Chuẩn hóa câu hỏi', 'Loại stopwords', 'Chấm điểm tài liệu theo keyword', 'Trả lời kèm nguồn'], reflection: 'Keyword truy xuất đơn giản nhưng đủ để hiểu tư duy RAG.' },
  { id: 'lab-no-answer', type: 'Lab an toàn', title: 'No-answer Behavior', goal: 'Dạy AI không đoán bừa khi thiếu dữ liệu.', scenario: 'Tài liệu không nói về câu hỏi của người dùng.', steps: ['Kiểm tra điểm truy xuất', 'Nếu điểm thấp, trả lời không đủ dữ liệu', 'Gợi ý người dùng bổ sung tài liệu'], reflection: 'Không trả lời bừa là một năng lực sản phẩm AI quan trọng.' },
  { id: 'lab-ml-split', type: 'Lab ML', title: 'Train/Test Split', goal: 'Hiểu vì sao cần dữ liệu kiểm thử.', scenario: 'Model học thuộc dữ liệu train nhưng sai khi gặp dữ liệu mới.', steps: ['Chia dữ liệu train/test', 'Train trên một phần', 'Đánh giá trên phần chưa thấy'], reflection: 'Không test riêng thì dễ tưởng model tốt hơn thực tế.' },
  { id: 'lab-eval', type: 'Lab đánh giá', title: 'Faithfulness Check', goal: 'Kiểm tra câu trả lời có bám nguồn không.', scenario: 'Chatbot trả lời thêm chi tiết không có trong tài liệu.', steps: ['So câu trả lời với nguồn', 'Gạch chân phần không có căn cứ', 'Sửa lại chỉ dựa trên nguồn'], reflection: 'Faithfulness giúp giảm hallucination trong ứng dụng tài liệu.' }
]

export const codeMissions = [
  { id: 'mission-glossary-cli', moduleId: 'm2-python', title: 'AI Glossary CLI', level: 'Nhập môn', folder: 'starter-kits/ai-glossary-cli', objective: 'Viết CLI nhập thuật ngữ AI và trả về giải thích dễ hiểu, ví dụ, phỏng vấn.', files: ['ai_glossary.py', 'README.md'], checks: ['Chạy được bằng python ai_glossary.py', 'Có ít nhất 8 thuật ngữ', 'Có README', 'Có 1 screenshot terminal'] },
  { id: 'mission-csv-analyzer', moduleId: 'm3-data', title: 'CSV Insight Analyzer', level: 'Thực hành', folder: 'starter-kits/csv-insight-analyzer', objective: 'Đọc CSV doanh thu và tạo báo cáo insight.', files: ['sales.csv', 'analyzer.py', 'README.md'], checks: ['Đọc được CSV', 'Tính doanh thu/chi phí/lợi nhuận', 'Tìm ngày tốt nhất', 'Có output mẫu'] },
  { id: 'mission-ml-predictor', moduleId: 'm4-ml', title: 'Demo dự đoán ML', level: 'Thực hành', folder: 'starter-kits/ml-predictor-demo', objective: 'Mô phỏng regression không cần thư viện nặng, hiểu train/test và error.', files: ['train_model.py', 'README.md'], checks: ['Có dữ liệu mẫu', 'Có train/test split', 'Có prediction', 'Có MAE/error'] },
  { id: 'mission-document-qa', moduleId: 'm5-llm', title: 'Hỏi đáp tài liệu offline', level: 'Theo hướng nghề', folder: 'starter-kits/document-qa-offline', objective: 'Mô phỏng RAG bằng keyword truy xuất, trả lời có nguồn và no-answer.', files: ['document_qa.py', 'README.md'], checks: ['Có tài liệu local', 'Có truy xuất score', 'Có sources', 'Có no-answer case', 'Có test questions'] },
  { id: 'mission-automation', moduleId: 'm6-automation', title: 'Workflow tự động hóa AI', level: 'Theo hướng nghề', folder: 'starter-kits/ai-automation-workflow', objective: 'Phân loại yêu cầu khách hàng, tạo checklist và phản hồi mẫu.', files: ['automation_workflow.py', 'README.md'], checks: ['Có classifier rule-based', 'Có trích xuất cơ bản', 'Có checklist', 'Có duyệt bởi con người step'] }
]

export const projects = [
  { id: 'ai-glossary-app', title: 'App từ điển thuật ngữ AI', level: 'Nhập môn', missionId: 'mission-glossary-cli', focus: 'Giải thích thuật ngữ AI cho người mới.', evidence: ['GitHub repo', 'README', 'Screenshot', '10 thuật ngữ', 'CV line'], interview: ['Vì sao app này hữu ích cho người mới?', 'Bạn tổ chức dữ liệu thuật ngữ thế nào?', 'Bạn sẽ nâng cấp app ra sao?'] },
  { id: 'data-insight-dashboard', title: 'Dashboard phân tích dữ liệu', level: 'Thực hành', missionId: 'mission-csv-analyzer', focus: 'Phân tích dữ liệu bán hàng mẫu.', evidence: ['sales.csv', 'script analyzer', 'summary output', 'README', 'insight section'], interview: ['Feature là gì trong project này?', 'Bạn xử lý dữ liệu thiếu thế nào?', 'Insight nào quan trọng nhất?'] },
  { id: 'ml-predictor-demo', title: 'Demo dự đoán ML', level: 'Thực hành', missionId: 'mission-ml-predictor', focus: 'Mô phỏng model dự đoán, train/test, metric.', evidence: ['dataset mẫu', 'train/test split', 'prediction output', 'metric', 'limitation'], interview: ['Regression là gì?', 'Vì sao cần test set?', 'Model này hạn chế gì?'] },
  { id: 'rag-document-assistant', title: 'Trợ lý tài liệu RAG', level: 'Theo hướng nghề', missionId: 'mission-document-qa', focus: 'Hỏi đáp tài liệu có nguồn.', evidence: ['documents local', 'truy xuất logic', 'answer with sources', 'no-answer case', 'đánh giá checklist'], interview: ['RAG khác chatbot thường ở đâu?', 'Retrieval sai thì chuyện gì xảy ra?', 'Bạn giảm hallucination thế nào?'] },
  { id: 'ai-automation-workflow', title: 'Workflow tự động hóa AI', level: 'Theo hướng nghề', missionId: 'mission-automation', focus: 'Tự động hóa phân loại, checklist, báo cáo.', evidence: ['workflow input/output', 'phân loại', 'checklist', 'duyệt bởi con người', 'README'], interview: ['Workflow này giải quyết vấn đề gì?', 'Khi nào cần duyệt bởi con người?', 'Bạn đo chất lượng automation ra sao?'] },
  { id: 'capstone-document-qa-assistant', title: 'Capstone nghề AI: Trợ lý hỏi đáp tài liệu', level: 'Capstone', missionId: 'mission-document-qa', focus: 'Project cuối: Document Q&A có nguồn, test set, rubric 100 điểm, portfolio kit.', evidence: ['UI hoặc CLI demo', '5 tài liệu mẫu', '10 test questions', 'truy xuất score', 'faithfulness/no-answer', 'README', 'CV line', 'interview defense'], interview: ['Hãy giải thích kiến trúc project của bạn.', 'Làm sao biết câu trả lời đúng nguồn?', 'Nếu nâng lên bản thật, bạn dùng API/vector DB thế nào?'] }
]

export const proofSteps = [
  { id: 'learn', label: 'Học', description: 'Hoàn thành bài nền liên quan.' },
  ...
  { id: 'build', label: 'Build', description: 'Có sản phẩm/deliverables chạy được.' },
  { id: 'explain', label: 'Giải thích', description: 'Trả lời được câu hỏi phỏng vấn.' },
  { id: 'portfolio', label: 'Portfolio', description: 'Có GitHub/README/CV line/screenshot.' }
]

export const capstoneDocuments = [
  { id: 'doc-rag', title: 'RAG Workflow', source: 'Bootcamp Doc 01', text: 'RAG gồm truy xuất và generation. Retrieval tìm đoạn tài liệu liên quan, generation tạo câu trả lời dựa trên đoạn đó. RAG giúp câu trả lời bám nguồn hơn nhưng vẫn cần đánh giá.' },
  ...
  { id: 'doc-eval', title: 'Evaluation Set', source: 'Bootcamp Doc 03', text: 'Evaluation set gồm câu hỏi kiểm thử, expected source và expected answer. Nó giúp kiểm tra truy xuất, faithfulness và độ hữu ích của câu trả lời.' },
  { id: 'doc-chia tài liệu', title: 'Chunking Strategy', source: 'Bootcamp Doc 04', text: 'Tài liệu dài cần chia thành chunk để truy xuất dễ tìm đúng phần liên quan. Chunk quá dài làm loãng thông tin, chunk quá ngắn mất ngữ cảnh.' },
...
export const capstoneTestSet = [
  { q: 'RAG gồm những bước nào?', expectedSource: 'doc-rag', expectedKeywords: ['truy xuất', 'generation'] },
  { q: 'Làm sao giảm hallucination?', expectedSource: 'doc-hallucination', expectedKeywords: ['citation', 'no-answer', 'đánh giá'] },
  { q: 'Evaluation set dùng để làm gì?', expectedSource: 'doc-eval', expectedKeywords: ['expected source', 'expected answer', 'faithfulness'] },
  { q: 'Vì sao cần chia tài liệu?', expectedSource: 'doc-chia tài liệu', expectedKeywords: ['chunk', 'ngữ cảnh'] },
  ...
  { q: 'RAG có đảm bảo đúng 100% không?', expectedSource: 'doc-rag', expectedKeywords: ['đánh giá', 'không'] },
  { q: 'Nếu truy xuất lấy sai đoạn thì sao?', expectedSource: 'doc-rag', expectedKeywords: ['truy xuất', 'liên quan'] },
...
export const capstoneRubric = [
  ...
  { id: 'truy xuất', label: 'Có truy xuất logic và truy xuất score', points: 15 },
  ...
  { id: 'eval', label: 'Có test set, expected source/answer và đánh giá checklist', points: 15 },
...
export const quests = [
  { id: 'quest-career', title: 'Nhiệm vụ 01: Chọn hướng nghề thật', task: 'Chọn một vị trí mục tiêu và viết lý do trong 3 dòng.', reward: '+Rõ hướng nghề' },
  ...
  { id: 'quest-portfolio', title: 'Nhiệm vụ 05: Cửa portfolio', task: 'Tạo README cho ít nhất 1 project.', reward: '+Sẵn sàng ứng tuyển' }
]
...
export const dailyChallenges = [
  ...
  { id: 'daily-debug', title: 'Debug truy xuất sai', time: '5 phút', task: 'Nếu câu hỏi về hallucination nhưng truy xuất lấy tài liệu portfolio, nguyên nhân có thể là gì?' }
]

export const bossBattles = [
  { id: 'boss-hallucination', title: 'Boss Hallucination', prompt: 'AI trả lời rất tự tin nhưng không có nguồn. Bạn làm gì?', answer: 'Yêu cầu nguồn, kiểm tra truy xuất, nếu thiếu dữ liệu thì trả lời no-answer.' },
  ...
  { id: 'boss-broken-rag', title: 'Boss Broken RAG', prompt: 'Chatbot trả lời sai dù có tài liệu đúng. Debug từ đâu?', answer: 'Kiểm tra chia tài liệu, truy xuất score, prompt, context và faithfulness.' }
]
...
export const detectiveCases = [
  ...
  { id: 'detective-user-trust', title: 'Case: Người dùng không tin chatbot', symptoms: ['Không rõ nguồn', 'Không có limitation', 'Không có test case'], suspects: ['README yếu', 'UI thiếu source', 'Không có đánh giá report'], fix: 'Thêm source panel, test set, score và phần limitation.' }
]
...
export const mistakeMuseum = [
  ...
  { id: 'mistake-rag-magic', title: 'Tưởng RAG là phép màu', lesson: 'RAG vẫn sai nếu truy xuất, chia tài liệu hoặc nguồn dữ liệu sai.' },
  { id: 'mistake-no-eval', title: 'Không có đánh giá', lesson: 'Không test thì không biết app tốt hay chỉ nhìn có vẻ hay.' },
  { id: 'mistake-overclaim', title: 'Hứa quá mức', lesson: 'Portfolio tốt phải nói rõ giới hạn hiện tại và hướng nâng cấp.' }
]

export const skillTree = [
  { group: 'Khái niệm AI', skills: ['AI/ML/DL/LLM', 'Token/Context', 'RAG', 'Hallucination', 'Evaluation'] },
  { group: 'Python & Dữ liệu', skills: ['Function', 'List/Dict', 'CSV/JSON', 'Debug', 'Insight'] },
  { group: 'Nền tảng ML', skills: ['Train/Test', 'Regression', 'Classification', 'Metric', 'Overfitting'] },
  { group: 'App LLM', skills: ['Prompt', 'Chunking', 'Retrieval', 'Citation', 'No-answer'] },
...
export const placementQuestions = [
  ...
  { id: 'pq3', q: 'Bạn có giải thích được RAG không?', options: ['Chưa', 'Giải thích đơn giản', 'Giải thích được truy xuất + generation'], scores: [0, 1, 2] },
  { id: 'pq4', q: 'Bạn đã có repo GitHub project nào chưa?', options: ['Chưa', 'Có nhưng sơ sài', 'Có README/demo rõ'], scores: [0, 1, 2] },
  { id: 'pq5', q: 'Bạn muốn ứng tuyển hướng nào trước?', options: ['AI App Builder', 'AI Automation', 'LLM App Developer', 'Nền tảng ML'], scores: [1, 1, 1, 1] }
]

export const careerTracks = [
  { id: 'track-app-builder', title: 'AI App Builder', bestFor: 'Người mới muốn build app AI có UI, workflow rõ và demo được nhanh.', focus: ['Nền tảng LLM', 'RAG offline', 'Giao diện React', 'README', 'Capstone'], targetRoles: ['Junior AI App Builder', 'AI Solutions Builder Intern'], mustShip: ['Document Q&A Assistant', 'Gói xuất portfolio'] },
  { id: 'track-automation', title: 'AI Automation Assistant', bestFor: 'Người muốn làm workflow cho khách hàng/doanh nghiệp nhỏ.', focus: ['Quy ước input/output', 'phân loại', 'trích xuất', 'tạo báo cáo', 'duyệt bởi con người'], targetRoles: ['AI Automation Assistant', 'AI Workflow Builder'], mustShip: ['Workflow tự động hóa AI', 'Kho bằng chứng'] },
  { id: 'track-llm-dev', title: 'LLM Application Developer Intern', bestFor: 'Người muốn đi sâu chatbot, RAG, đánh giá và app có nguồn.', focus: ['Prompt', 'chia tài liệu', 'truy xuất', 'trích nguồn', 'đánh giá'], targetRoles: ['LLM App Developer Intern', 'RAG Assistant Builder'], mustShip: ['Document Q&A 2.0', 'Báo cáo đánh giá Capstone'] },
  { id: 'track-ml-foundation', title: 'ML Engineer Foundation', bestFor: 'Người muốn xây nền Python/Data/ML trước khi học production ML sâu hơn.', focus: ['Python', 'làm sạch dữ liệu', 'train/test', 'chỉ số đánh giá', 'giới hạn'], targetRoles: ['AI/ML Intern Foundation', 'Data/AI Assistant'], mustShip: ['CSV Analyzer', 'ML Predictor Demo'] }
]

export const evidenceTypes = [
  { id: 'github', label: 'Repo GitHub', placeholder: 'https://github.com/username/project-name', weight: 25 },
  { id: 'readme', label: 'Tóm tắt README', placeholder: 'Dán phần problem/features/how-to-run/giới hạn...', weight: 18 },
  { id: 'screenshot', label: 'Ảnh demo/ghi chú demo', placeholder: 'Ghi ảnh demo hoặc đường dẫn ảnh trong repo...', weight: 15 },
  { id: 'terminal', label: 'Kết quả terminal', placeholder: 'Dán kết quả chạy code mission...', weight: 12 },
  { id: 'cv', label: 'Dòng CV', placeholder: 'Ví dụ: Built an offline Document Q&A Assistant...', weight: 15 },
  { id: 'defense', label: 'Bảo vệ project khi phỏng vấn', placeholder: 'Problem → Approach → Result → Limitation → Next step', weight: 15 }
]

export const productionLabs = [
  { id: 'prod-debug-wrong-answer', title: 'Debug chatbot trả lời sai', scenario: 'User hỏi đúng chủ đề nhưng answer sai nguồn.', decisionTree: ['Kiểm tra câu hỏi có nằm trong scope không', 'Kiểm tra truy xuất lấy đúng chunk chưa', 'Kiểm tra prompt có ép citation/no-answer không', 'Kiểm tra answer có thêm thông tin ngoài source không'], output: 'Viết incident note 5 dòng: nguyên nhân, cách sửa, test lại.' },
  ...
  { id: 'prod-eval-gate', title: 'Evaluation gate trước khi demo', scenario: 'Capstone chạy được nhưng chưa biết đúng hay sai.', decisionTree: ['Tạo 10 test questions', 'Đặt expected source', 'Chạy no-answer test', 'Ghi truy xuất/faithfulness score'], output: 'Tạo bảng đánh giá report cho GitHub.' }
]
...
export const spacedReviewCards = [
  ...
  { id: 'sr-hallucination', topic: 'Hallucination', front: 'AI trả lời tự tin nhưng không có nguồn là gì?', back: 'Hallucination. Cần citation, no-answer, đánh giá và human review.' },
  ...
  { id: 'sr-readme', topic: 'README', front: 'README portfolio cần có gì?', back: 'Problem, features, tech stack, how to run, screenshots, giới hạn, next steps.' },
...
export const portfolioExportPack = [
  'README GitHub chuẩn cho từng project',
  'Dòng CV cho 5 project + capstone',
  'Bài đăng LinkedIn tiếng Việt/Anh',
  'Kịch bản bảo vệ project khi phỏng vấn',
  'Capstone đánh giá report',
  'Kế hoạch cải thiện 90 ngày sau MVP'
]
